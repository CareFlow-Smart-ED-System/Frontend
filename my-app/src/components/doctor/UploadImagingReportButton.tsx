...
import { useUploadImagingReport } from '@/hooks/useDoctors'
...
export function UploadImagingReportButton({ imagingId }: Props) {
  const { mutate, isPending, isSuccess, isError, error } = useUploadImagingReport(imagingId)
