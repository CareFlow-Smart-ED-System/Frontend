      ...
      { patientId },
      {
        onSuccess: (data) => {
          setCaseCreationStatus({
            success: true,
            message: `Emergency case #${data.caseId} created successfully.`,
            caseId: data.caseId,
          });
        },
        onError: () => {
          setCaseCreationStatus({
            success: false,
            message: "Failed to create emergency case. Please try again.",
          });
        },
      },
    );
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-white border border-gray-100 rounded-2xl p-5">
              ...
              <p className="text-sm text-gray-500 mb-4 leading-relaxed">
                After quick registration, create an emergency case so the
                patient can move to triage and appear in the ED queue.
              </p>
              ...
              {caseCreationStatus?.success && (
                <div className="bg-green-50 border border-green-200 rounded-lg p-3 mb-3">
                  <p className="text-sm font-medium text-green-800">
                    {caseCreationStatus.message}
                  </p>
                  {caseCreationStatus.caseId && (
                    <p className="text-xs text-green-700 mt-1">
                      Case ID: {caseCreationStatus.caseId}
                    </p>
                  )}
                </div>
              )}
              ...
              {/* Error message */}
              {caseCreationStatus && !caseCreationStatus.success && (
    ...
    >
      <div>
        ...
        <p className="text-xs text-gray-500 mt-1">
          Use this after quick registration to complete or correct the
